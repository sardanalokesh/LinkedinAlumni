...
author lokesh.sardana (lsardana@gmail.com)

With the help of this script, you can easily fetch the details of your school's alumni present in your linkedin network.
...
5. Set the total number of records you want to fetch. Better to keep this number not very high. Too many calls to linkedin server may block your account
6. The 'count' variable is to set number of records to fetch per iteration. However, linkedin doesn't allow you to fetch more than 200
record per transaction. So, do not set it beyond that value.
